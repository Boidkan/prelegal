 ...
 *
 * This is the static legal text that accompanies the user-completed Cover Page.
 * It is sourced verbatim from `templates/Mutual-NDA.md` in the repository root
 * and kept here as the single source of truth so the preview, the Markdown
 * export, and the PDF export never drift apart.
 *
 * Free to use under CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/).
 */

export type StandardClause = {
  /** Bold clause heading, e.g. "Introduction". */
  title: string;
  /** Clause body text. */
  body: string;
};
...
/** Short explanatory blurb shown beneath the title in the preview and PDF. */
export const COVER_PAGE_INTRO =
  "This MNDA consists of this Cover Page and the Common Paper Mutual NDA " +
  "Standard Terms Version 1.0. Any modifications are made on the Cover Page, " +
  "which controls over conflicts with the Standard Terms.";

export const STANDARD_TERMS: StandardClause[] = [
  {
    title: "Introduction",
